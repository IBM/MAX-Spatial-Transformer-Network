...
train_data_path = os.environ["DATA_DIR"]+"/mnist_sequence1_sample_5distortions5x5.npz"
...
x = tf.placeholder(tf.float32, [None, 1600], name='input_data')
...
predictor = tf.argmax(y_logits, 1, name="predictor")
